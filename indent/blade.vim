" Vim indent file
" Language:	Blade
" Authors:	Miles Lott <milos@groupwhere.org>, Johannes Zellner <johannes@zellner.org>, Pim Snel <pim@lingewoud.nl>, Micah Bucy <micah.bucy@eternalsword.com>
" URL:		http://github.com/eternalsword/blade.vim/indent/blade.vim
" Last Change:	10 Sep 2013
" Version:	0.1
" Notes:  	This is a combination of the PHP indent file minus non-blade php of Miles Lott with 
"         	the HTML indent file of Johannes Zellner, with blade
"         	indentation by Micah Bucy. Useful for editing 
"         	blade template files.
"         	

" Options: 
let php_noindent_switch=0    " set this to '1' to not try to indent switch/case statements
set tabstop=4 softtabstop=4 shiftwidth=4 noexpandtab " set default tab settings
